...
const About = () => (
  <div className="about-container">
    ...
    <p className="about-paragraph">I am a Software Developer working at Trend Micro. I completed Lambda School’s 9 month Full Stack Web Development course, during which time I spent 8 hours a day learning React, Node.js, Python, and much more.</p>

...
const About = () => (
  <div className="about-container">
    ...
    <p className="about-paragraph">I am an extremely motivated Full Stack Software Developer seeking a career in the software field. I completed Lambda School’s 9 month Full Stack Web Development course, during which time I spent 8 hours a day learning React, Node.js, Python, and much more.</p>

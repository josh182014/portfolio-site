...
const Nav = (props) => {
  ...
  return (
    <div className="navContainer">
      ...
      <div onClick={handleClick} className="popup-nav-overlay nav-transition hidden-popup-nav" />
      ...
      <div id="test" className="popup-contact-nav hidden-popup-contact-nav contact-transition-length-open">
        <nav className="contact-nav-form">
          <i onClick={handleContactBackClick} className="fas fa-chevron-down fa-2x" />
          <h2>Contact Me</h2>
          {formSubmitted
            ? (
            ...
            : (
              <>
                <p>
I'm currently looking for new opportunites.
                  <a href="/assets/resume.pdf" download="josh-timmons-resume" target="_blank">Here</a>
                  {' '}
is a link to download a pdf version of my resume. (Clicking the link will automatically download the pdf.) Please fill out this form and I will get back to you as fast as I can!
                </p>

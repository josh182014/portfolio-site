const dummyProjects = [
  ...
  {
    name: 'RLACF Volunteer App (In Development)', github: 'https://github.com/RLACF-App', mainLanguage: 'JavaScript', description: 'An app I built for the Red Lodge Area Community Foundation. People are able to browse volunteer opportunites in their community and sign up to volunteer for them. The frontend is build with React.js and Redux and the backend is built using Express.js and Postgres to store volunteer opportunity data.', viewLive: 'https://rlacf-app.netlify.com', img: 'assets/rlacf.png', tech: ['React w/Hooks,', 'Redux,', 'Node.js,', 'Express.js,', 'Postgres'],
  },
  {

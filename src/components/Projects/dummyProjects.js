const dummyProjects = [
    {
        name: 'Test Poject', github: 'github.com', mainLanguage: 'javascript', description: 'This is a test description for my test project. Bla bla bla.', img: 'assets/great-idea.PNG'
    },
    {
